                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm">Disponível</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="/reservar" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">Reservar</a>
                        </div>
                    </div>
                </div>
